...
-   **`WakeWord`**: Detects keywords (for example, the Xiaozhi wake phrase or "Hi, ESP") from the audio stream. It runs independently from the main audio processor until a wake word is detected.
